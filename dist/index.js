...
eval("__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {\n__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_TvShowApi_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/TvShowApi.js */ \"./src/modules/TvShowApi.js\");\n/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./style.scss */ \"./src/style.scss\");\nvar __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_modules_TvShowApi_js__WEBPACK_IMPORTED_MODULE_0__]);\n_modules_TvShowApi_js__WEBPACK_IMPORTED_MODULE_0__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];\n\r\n\r\n// import { renderModal, hideModal } from './modules/renderModal.js';\r\n\r\nconst modal = document.querySelector('section');\r\nconst closeModal = document.getElementById('close-button');\r\n\r\nlet body = '';\r\n_modules_TvShowApi_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].forEach((movie) => {\r\n  body += `<div id=\"${movie.id}\" class=\"card\">\r\n        <img src=\"#\" />\r\n        <a>${movie.name}</a>\r\n        <i class=\"fa-regular fa-heart\"></i>\r\n        <p>5 likes</p>\r\n        <button class=\"button\" id=${movie.id} data-target=\"#popup-wrapper\">Comments</button>\r\n      </div>`;\r\n});\r\n\r\nconst main = document.querySelector('main');\r\nmain.innerHTML = body;\r\n\r\nconst renderModal = (e) => {\r\n  e.target.className.includes('button');\r\n  if (e.target.className.includes('button')) {\r\n    modal.style.display = 'block';\r\n    console.log('clicked', e.target.id);\r\n  }\r\n};\r\n\r\nconst hideModal = () => {\r\n  modal.style.display = 'none';\r\n};\r\n\r\ndocument.addEventListener('click', () => {\r\n  renderModal();\r\n  // e.target.className.includes('button');\r\n  // if (e.target.className.includes('button')) {\r\n  //   modal.style.display = 'block';\r\n  //   console.log('clicked', e.target.id);\r\n  // }\r\n});\r\ncloseModal.addEventListener('click', () => {\r\n  // modal.style.display = 'none';\r\n  hideModal();\r\n});\r\n\n__webpack_async_result__();\n} catch(e) { __webpack_async_result__(e); } });\n\n//# sourceURL=webpack://capstone-2/./src/index.js?");
...
eval("__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {\n__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst fetchResult = await fetch('https://api.tvmaze.com/shows');\r\nconst jsonResult = await fetchResult.json();\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (jsonResult.slice(0, 12));\r\n\n__webpack_async_result__();\n} catch(e) { __webpack_async_result__(e); } }, 1);\n\n//# sourceURL=webpack://capstone-2/./src/modules/TvShowApi.js?");
